       ...
       $('#sign_up').on("click",function()
           {
                ...
                if(((first_name.match(regrex_of_name)) && (first_name!=" ")) && ((last_name.match(regrex_of_name))&& (last_name!=" ") ) && ((password_of_user.match(regrex_of_password )) && (password_of_user!=" ")) && (confirm_password==password_of_user) && (email_of_user.match(regrex_of_email) ))
                   {
                       $.ajax
                       ({
                               url:'/Sign_Up_Data',
